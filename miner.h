...
extern int scanhash_x12r(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_x12r(int thr_id);
...
void x12r_hash(void *output, const void *input);
